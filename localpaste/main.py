...
from .api import (DbInit, NewPaste, DeletePaste,
                  ...
                  SelectNextX, SelectDb, UserLogin,
                  UserLogout)
...
def showPost(pasteId):
    ...
    if paste:
        ...
        return render_template("view.html", Title=data["Name"], pasteId=pasteId, data=data)

    else:
        data = {"Error": "No such paste"}
        return render_template("view.html", Title="No such paste",
                                pasteId=pasteId, data=data)
